...
declare class AlleChat {
     ...
     * ```
     */
    completions(request: ApiRequest): Promise<any>;
    /**
     ...
     * ```
     */
    combination(request: ApiRequest): Promise<any>;
    /**
     ...
     * ```
     */
    comparison(request: ApiRequest): Promise<any>;
    /**
     ...
     * ```
     */
    search(request: ApiRequest): Promise<any>;
}
export { AlleChat };
